...
class StudentController extends Controller
{
    ...
    public function update(Request $r, Student $student)
    {
        ...
        $fee          = (float) ($setting->semestral_fee ?? 0);
        ...
        // Sync TermBalance using raw DB to force stored column recompute
        if ($setting) {
            $newTotalPaid = $total;
            ...
            if ($exists) {
                ...
                $breakdown = $carriedOver > 0 ? json_encode([[
                    'type'             => 'carry_over',
